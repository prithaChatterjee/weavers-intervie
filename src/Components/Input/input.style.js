...
& > div{
    ...
    & > label{
        top: ${(props) => props.value ? "-20px" : "0"};
        width: auto;
        position: absolute;    
        padding: ${(props) => props.value ? "5px 10px" : props.variant === "outline" ? "10px 10px" : "10px 0px"};
        background: ${(props) => props.value ? "#ffffff" : "transparent"};
        z-index: ${(props) => props.value ? "1" : "-1"};
        left: ${(props) => props.value ? props.variant === "outline" ? "5px" : "0" : "0"};
